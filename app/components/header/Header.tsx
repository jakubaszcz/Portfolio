export function Header() {
    return (
        <header className="fixed inset-x-0 top-0 z-50 bg-primary-950 lg:bg-transparent">
            <div className="mx-auto flex max-w-8xl flex-wrap items-center justify-between gap-x-3 gap-y-2 px-4 py-4 sm:px-10">
                ...
                <nav aria-label="Main navigation" className="flex items-center gap-3 text-xs text-primary-200 sm:gap-7 sm:text-sm">
                    <a href="#path" className="header-link inline-flex min-h-11 items-center">My path</a>
